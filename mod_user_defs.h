 ...
 */
#define uart_swd_frec 115200//max=>dco_frec_MHz*1000000/uart_s1_frec-14, el resultado debe ser mayor 10
#define uart_software_tx 	SR2_Ec
#define uart_software_rx 	SR1_Tr
